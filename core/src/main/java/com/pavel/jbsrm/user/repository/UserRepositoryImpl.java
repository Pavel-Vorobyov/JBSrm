...
public class UserRepositoryImpl extends QuerydslRepositorySupport implements UserRepositoryCustom {
    private final String queryStart = "select id, login, password, name, surname, user_gender, passport_series, passport_issued_by, birthday, mail, phone, company_id, user_role, create_at, " +
            "deleted from \"user\" where as_tsvector(name, surname, mail, phone) @@ to_tsquery('";
