        ...
        {numSelected > 0 ? (
          ...
          <div style={{width: '500px', height: '0'}}>
            ...
            <TextField
              ...
              label="User role"
              value={propsValue.userRole}
              className='table-search-props'
              onChange={(event) => props.handlePropChange('userRole', event)}
              SelectProps={{
                MenuProps: {
                  className: 'prop-menu',
                },
...
class EnhancedTable extends React.Component {
  ...
  render() {
    ...
    const { handleChangeRowsPerPage, handleChangePage, handlePropChange, propsValue } = this.props;
