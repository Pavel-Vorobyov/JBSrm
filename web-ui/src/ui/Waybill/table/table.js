...
let EnhancedTableToolbar = props => {
  const { numSelected, classes, selected, defaultTableHead, propsValue } = props;
  const { newClicked, closeClicked } = props;
      ...
      <div className={classes.actions}>
        {numSelected > 0 ? (
          <div style={{width: '200px'}}>
            <Tooltip title="Mark waybill as complete">
              <Button variant='outlined' style={{height: '5px', padding: '0', marginRight: '20px'}} onClick={() => closeClicked(selected)}>Close</Button>
            </Tooltip>
          ...
          <div style={{width: '620px', height: '0'}}>
          ...
          <TextField
            ...
            <Tooltip title="Create new entity">
              <Button variant='outlined' style={{height: '5px', padding: '0'}} onClick={newClicked}>New</Button>
            </Tooltip>
...
class EnhancedTable extends React.Component {
  ...
  render() {
    ...
    const {data, defaultTableHead, rows, newClicked, pageParams, closeClicked } = this.props;
