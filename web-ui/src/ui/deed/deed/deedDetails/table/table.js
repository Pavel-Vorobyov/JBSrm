...
let EnhancedTableToolbar = props => {
  const { numSelected, classes, selected, defaultTableHead, handlePropChange } = props;
    ...
    >
      ...
      <div className={classes.actions}>
        {numSelected > 0 ? (
          ...
          <div style={{width: '100px', float: 'right', height: '0'}}>
...
class EnhancedTable extends React.Component {
  ...
  render() {
    ...
    const { handleChangeRowsPerPage, handleChangePage, filters, showSelectProduct } = this.props;
